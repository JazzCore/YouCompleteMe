...
class VimCompleter( Completer ):
  ...
  def CandidatesForQueryAsyncInner( self, unused_query ):
    ...
    self.completer.CandidatesForQueryAsync(unused_query)
  ...
  def OnFileReadyToParse( self ):
    self.completer.AddBufferIdentifiers()


  def OnInsertLeave( self ):
    self.completer.AddIdentifierUnderCursor()


  def OnCurrentIdentifierFinished( self ):
    self.completer.AddPreviousIdentifier()

  def CandidatesFromStoredRequestInner( self ):
    vim.command("cal Decho(%s)" % _vim.escape(self.completer.CandidatesFromStoredRequest()))
    return self.completer.CandidatesFromStoredRequest() or []
